...
type TabType = 'properties' | 'timeline' | 'linkedin';
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex border-b mt-4">
                    ...
                    >
                        <svg className="h-5 w-5 inline mr-2" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="mt-6">
                    ...
                    {activeTab === 'linkedin' && (
                        <LinkedInTab prospectPhone={prospectPhone as any} />
                    )}
                </div>
            </DialogContent>
        </Dialog >
