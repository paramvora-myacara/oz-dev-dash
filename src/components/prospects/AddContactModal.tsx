...
interface AddContactModalProps {
    ...
    onClose: () => void;
    onSuccess: () => void;
    onSelectMatch?: (phone: ProspectPhone) => void;
}
...
export default function AddContactModal({ isOpen, onClose, onSuccess, onSelectMatch }: AddContactModalProps) {
    ...
    const [phoneMatches, setPhoneMatches] = useState<ProspectPhone[]>([]);
                                                ...
                                                >
                                                    ...
                                                    {p.prospect && (
                                                        <div className="text-sm mt-1 text-muted-foreground flex items-center gap-1">
                                                            <span>{p.prospect.propertyName}</span>
                                                            <span className="opacity-50">·</span>
                                                            <span>{p.prospect.city}, {p.prospect.state}</span>
                                                        </div>
                                                    )}
                                                </div>
                                            );
