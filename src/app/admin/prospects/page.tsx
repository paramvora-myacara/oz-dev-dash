  ...
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center bg-slate-50 p-6">
      <div className="max-w-md w-full bg-white rounded-3xl border shadow-xl p-10 text-center space-y-8 animate-in zoom-in-95 duration-500">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">Prospects have moved!</h1>
          <p className="text-slate-500 font-medium leading-relaxed">
            Calling and prospect management are now in the <span className="text-blue-600 font-bold">Consolidated CRM</span> for a better workflow.
          </p>
        </div>
