...
export default function PropertyOverviewPage() {
  const amenities = [
    ...
    { name: "Pet-Friendly Amenities", icon: <Dog className="w-6 h-6" /> },
    { name: "Concierge Services", icon: <Bell className="w-6 h-6" /> },
    { name: "Electric Vehicle Charging", icon: <Zap className="w-6 h-6" /> },
    { name: "Package Management", icon: <Package className="w-6 h-6" /> }
  ];
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              ...
              <p className="text-xl text-indigo-700 dark:text-indigo-400 mt-2">
                SoGood Dallas - Master-Planned Innovation District
              </p>
            </div>
          </div>
        </div>
